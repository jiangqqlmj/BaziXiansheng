package com.example.administrator.bazipaipan.amuse.view.activity.activity;
 ...
 */
public class AmuseContainerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //switch case逻辑区别
        if (AmuseContainerActivity.this.getIntent().getStringExtra(PAGETO) == null) {
            return;
        }
        mPageTo = AmuseContainerActivity.this.getIntent().getStringExtra(PAGETO);
        if (mPageTo == null) {
    ...
    private void switchFragment(String mPageTo) {
        ...
        switch (mPageTo) {
            case AmuseDetailFragment.TAG:
                ...
                break;
            case AmuseFragment.TAG:
                fragment = AmuseFragment.newInstance();
                break;
